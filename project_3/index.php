                        ...
                        <div class="row justify-content-between mil-p-120-90">
                            ...
                            <div class="col-lg-6">
                                ...
                                echo "
                                        ...
                                        <p class='mil-up mil-mb-30'>$grid_co_paragraph_two</p>
                                    ";
                                ?>
                            </div>
                        </div>
                        <div class="mil-works-nav mil-up">
                            ...
                            if ($grid_co_query) {
                                ...
                                while ($grid_co_data = mysqli_fetch_assoc($grid_co_query)) {
                                    ...
                                    $grid_co_role_two = $grid_co_data['role_two'];
                                    $grid_co_id = base64_encode($grid_co_data['id']);
                                    $grid_co_id = base64_encode(2);


                                    $num++;
                                }
                                echo "
                                    <a href='../project_2/?project= " . $grid_co_id . "' class='mil-link mil-dark mil-arrow-place mil-icon-left'>
                            ...
                            if ($grid_co_query) {
                                ...
                                echo "
                                    <a href='../project_4/?project= " . $grid_co_id . "' class='mil-link mil-dark mil-arrow-place'>
