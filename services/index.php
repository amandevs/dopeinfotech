    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                        ...
                        <div class="mi-invert-fix">
                            <div class="mil-banner-content mil-up">
                                ...
                                <div class="container">
                                    ...
                                    include "../connection/connection.php";
                                    $services_head_n_foot_sql = "SELECT * FROM `services_head_n_foot` WHERE 1";
                                    $services_head_n_foot_query = mysqli_query($connect, $services_head_n_foot_sql);
                                    $num = 1;
                                    while ($services_head_n_foot_data = mysqli_fetch_assoc($services_head_n_foot_query)) {
                                        $services_head_n_foot_user_id = $services_head_n_foot_data['user_id'];
                                        $services_head_one = $services_head_n_foot_data['services_head_one'];
                                        $services_head_two = $services_head_n_foot_data['services_head_two'];
                                        $services_head_three = $services_head_n_foot_data['services_head_three'];
                                        $services_head_four = $services_head_n_foot_data['services_head_four'];
                                        $services_head_button = $services_head_n_foot_data['services_head_button'];
                                        $services_head_n_foot_id = $services_head_n_foot_data['id'];
                                    ...
                                    <?php
                                    echo "
                                    <h1 class='mil-muted mil-mb-60'>$services_head_one <span class='mil-thin'>$services_head_two</span><br> $services_head_three <span class='mil-thin'>$services_head_four</span></h1>
                                    <a href='#services' class='mil-link mil-accent mil-arrow-place mil-down-arrow'>
                                        <span>$services_head_button</span>
                                    </a>
                                    ";
                                    ?>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="row">
                                            ...
                                            <?php
                                            $services_body_sql = "SELECT * FROM `services_body` WHERE 1";
                                            $services_body_query = mysqli_query($connect, $services_body_sql);
                                            $num = 1;
                                            while ($services_body_data = mysqli_fetch_assoc($services_body_query)) {
                                                $services_body_user_id = $services_body_data['user_id'];
                                                $services_body_head_one = $services_body_data['services_body_head_one'];
                                                $services_body_head_two = $services_body_data['services_body_head_two'];
                                                $services_body_paragraph = $services_body_data['services_body_paragraph'];
                                                $services_body_one = $services_body_data['services_body_one'];
                                                $services_body_two = $services_body_data['services_body_two'];
                                                $services_body_three = $services_body_data['services_body_three'];
                                                $services_body_four = $services_body_data['services_body_four'];
                                                $services_body_button = $services_body_data['services_body_button'];
                                                $services_body_head_one_2 = $services_body_data['services_body_head_one_2'];
                                                $services_body_head_two_2 = $services_body_data['services_body_head_two_2'];
                                                $services_body_paragraph_2 = $services_body_data['services_body_paragraph_2'];
                                                $services_body_one_2 = $services_body_data['services_body_one_2'];
                                                $services_body_two_2 = $services_body_data['services_body_two_2'];
                                                $services_body_three_2 = $services_body_data['services_body_three_2'];
                                                $services_body_four_2 = $services_body_data['services_body_four_2'];
                                                $services_body_button_2 = $services_body_data['services_body_button_2'];
                                                $services_body_id = $services_body_data['id'];
                                                echo "
                                            <div class='col-md-6 col-lg-6'>
                                                <a href='../service/' class='mil-service-card-lg mil-more mil-accent-cursor mil-offset'>
                                                    <h4 class='mil-muted mil-up mil-mb-30'>$services_body_head_one <br>$services_body_head_two</h4>
                                                    <p class='mil-descr mil-light-soft mil-up mil-mb-30'$services_body_paragraph</p>
                                                    <ul class='mil-service-list mil-light mil-mb-30'>
                                                        <li class='mil-up'>$services_body_one</li>
                                                        <li class='mil-up'>$services_body_two</li>
                                                        <li class='mil-up'>$services_body_three</li>
                                                        <li class='mil-up'>$services_body_four</li>
                                                    </ul>
                                                    <div class='mil-link mil-accent mil-arrow-place mil-up'>
                                                        <span>$services_body_button</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class='col-md-6 col-lg-6'>
                                                <a href='../service/' class='mil-service-card-lg mil-more mil-accent-cursor'>
                                                    <h4 class='mil-muted mil-up mil-mb-30'>$services_body_head_one_2 <br>$services_body_head_two_2</h4>
                                                    <p class='mil-descr mil-light-soft mil-up mil-mb-30'>$services_body_paragraph_2</p>
                                                    <ul class='mil-service-list mil-light mil-mb-30'>
                                                        <li class='mil-up'>$services_body_one_2</li>
                                                        <li class='mil-up'>$services_body_two_2</li>
                                                        <li class='mil-up'>$services_body_three_2</li>
                                                        <li class='mil-up'>$services_body_four_2</li>
                                                    </ul>
                                                    <div class='mil-link mil-accent mil-arrow-place mil-up'>
                                                        <span>$services_body_button_2</span>
                                                    </div>
                                                </a>
                                            </div>
                                            ";
                ...
                while ($services_head_n_foot_data = mysqli_fetch_assoc($services_head_n_foot_query)) {
                    $services_head_n_foot_user_id = $services_head_n_foot_data['user_id'];
                    $services_foot_subtitle_one = $services_head_n_foot_data['services_foot_subtitle_one'];
                    $services_foot_subtitle_two = $services_head_n_foot_data['services_foot_subtitle_two'];
                    $services_foot_one = $services_head_n_foot_data['services_foot_one'];
                    $services_foot_two = $services_head_n_foot_data['services_foot_two'];
                    $services_foot_three = $services_head_n_foot_data['services_foot_three'];
                    $services_foot_four = $services_head_n_foot_data['services_foot_four'];
                    $services_foot_button = $services_head_n_foot_data['services_foot_button'];
                    ...
                    <div class="container mil-p-120-120">
                        <div class="row">
                            <div class="col-lg-10">
                                <?php
                                echo "
                                <span class='mil-suptitle mil-suptitle-right mil-suptitle-dark mil-up'>$services_foot_subtitle_one <br> $services_foot_subtitle_two</span>
                                ";
                                ?>
                            </div>
                        </div>
                        <div class="mil-center">
                            <?php
                            echo "
                            <h2 class='mil-up mil-mb-60'>$services_foot_one <span class='mil-thin'>$services_foot_two</span><br> $services_foot_three <span class='mil-thin'>$services_foot_four</span></h2>
                            <div class='mil-up'><a href='../contact/' class='mil-button mil-arrow-place'><span>$services_foot_button</span></a></div>
                            ";
                            ?>
                        </div>
                    </div>
