                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mil-p-0-120">
                                    <ul class="mil-service-list mil-dark mil-mb-60">
                                        <li class="mil-up">Client : &nbsp;<span class="mil-dark">
                                                <?php echo $grid_co_client; ?> </span></li>
                                        <li class="mil-up">Date : &nbsp;
                                            <span class="mil-dark">
                                                <?php
                                        ...
                                        <li class="mil-up">Author : &nbsp;<span
                                                class="mil-dark"><?php echo $grid_co_author; ?></span></li>
                                    </ul>
                                    <?php
                                    echo "
                                            <h5 class='mil-up mil-mb-30'>$grid_co_paragraph_head</h5>
                                        ";
                                    ?>
                                    <?php
                                    echo "
                                            ...
                                            <p class='mil-up mil-mb-60'>$grid_co_paragraph_two</p>
                            ...
                            <div class="col-lg-7">
                                ...
                                echo "
                                        <div class='mil-image-frame mil-horizontal mil-up mil-mb-30'>
                                            ...
                                            <a data-fancybox='gallery' data-no-swup href='../img/grid/img_gallery/$grid_co_main_img' class='mil-zoom-btn'>
                        ...
                        <div class="mil-works-nav mil-up">
                            ...
                            if ($grid_co_query) {
                                ...
                                while ($grid_co_data = mysqli_fetch_assoc($grid_co_query)) {
                                    ...
                                    $grid_co_role_two = $grid_co_data['role_two'];
                                    $grid_co_id = base64_encode($grid_co_data['id']);
                                    $grid_co_id = base64_encode(1);


                                    $num++;
                                }
                                echo "
                                    <a href='../project_1/?project= " . $grid_co_id . "' class='mil-link mil-dark mil-arrow-place mil-icon-left'>
                            ...
                            if ($grid_co_query) {
                                ...
                                while ($grid_co_data = mysqli_fetch_assoc($grid_co_query)) {
                                    ...
                                    $grid_co_role_two = $grid_co_data['role_two'];
                                    $grid_co_id = base64_encode($grid_co_data['id']);
                                    $grid_co_id = base64_encode(3);


                                    $num++;
                                }
                                echo "
                                    <a href='../project_3/?project= " . $grid_co_id . "' class='mil-link mil-dark mil-arrow-place'>
