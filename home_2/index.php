        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                ...
                <section class="mil-banner-personal">
                    ...
                    include "../connection/connection.php";
                    $home_two_sql = "SELECT * FROM `home_2` WHERE 1";
                    $home_two_query = mysqli_query($connect, $home_two_sql);
                    $num = 1;
                    while ($home_two_data = mysqli_fetch_assoc($home_two_query)) {
                        $home_two_user_id = $home_two_data['user_id'];
                        $home_two_name = $home_two_data['name'];
                        $home_two_head_one = $home_two_data['head_one'];
                        $home_two_head_two = $home_two_data['head_two'];
                        $home_two_passion_one = $home_two_data['passion_one'];
                        $home_two_passion_two = $home_two_data['passion_two'];
                        $home_two_button = $home_two_data['button'];
                        $home_two_img = $home_two_data['img'];
                        $home_two_head = $home_two_data['head'];
                        $home_two_link_one = $home_two_data['link_one'];
                        $home_two_link_two = $home_two_data['link_two'];
                        $home_two_link_three = $home_two_data['link_three'];
                        $home_two_link_four = $home_two_data['link_four'];
                        $home_two_view = $home_two_data['view'];
                        $home_two_id = $home_two_data['id'];
                                ...
                                <div class="col-lg-6">
                                    ...
                                    echo "
                                            <div class='mil-personal-text'>
                                                <p class='mil-mb-60'>$home_two_name</p>
                                                <h1 class='mil-mb-60'>$home_two_head_one <br>$home_two_head_two</h1>
                                                <div class='row justify-content-center'>
                                                    <div class='col-lg-8'>
                                                    
                                                        <span class='mil-suptitle mil-suptitle-dark mil-mb-60'>$home_two_passion_one <br>$home_two_passion_two</span>
                                                    
                                                        <a href='../services/' class='mil-link mil-dark mil-arrow-place'>
                                                            <span>$home_two_button</span>
                                                        </a>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    echo "
                                            <div class='mil-portrait-frame'>
                                                <img src='../img/home_2/$home_two_img' alt='Portrait'>
                                            </div>
                                        ";
                                    ?>
                                    ...
                                    <div class='mil-right'>
                                        <div class='mil-social-frame'>
                                            <ul class='mil-social-icons mil-dark'>
                                                <li>
                                                    <a href='$home_two_link_one' target='_blank' class='social-icon'>
                                                ...
                                                <li>
                                                    <a href='$home_two_link_two' target='_blank' class='social-icon'>
                                                ...
                                                <li>
                                                    <a href='$home_two_link_three' target='_blank' class='social-icon'>
                                                ...
                                                <li>
                                                    <a href='$home_two_link_four' target='_blank' class='social-icon'>
                                        ...
                                        <a href='../portfolio_3/' class='mil-button mil-arrow-place'>
                                            <span>$home_two_view</span>
                                        </a>
                                    </div>
                                    ";
                                ?>
