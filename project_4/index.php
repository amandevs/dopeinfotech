                    ...
                    <div class="container mil-p-120-120">
                        ...
                        <div class="row justify-content-center mil-center mil-p-120-120">
                            <div class="col-lg-8">
                                ...
                                echo "
                                        ...
                                        <p class='mil-text-lg mil-up'>$grid_co_paragraph_one</p>
                                    ";
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="mil-works-nav mil-up">
                            ...
                            if ($grid_co_query) {
                                ...
                                echo "
                                    <a href='../project_3/?project= " . $grid_co_id . "' class='mil-link mil-dark mil-arrow-place mil-icon-left'>
                            ...
                            if ($grid_co_query) {
                                ...
                                echo "
                                    <a href='../project_5/?project= " . $grid_co_id . "' class='mil-link mil-dark mil-arrow-place'>
