                            ...
                            <div class="swiper-wrapper">
                                ...
                                echo "
                                        ...
                                        <div class='swiper-slide'>
                                            ...
                                            <div class='mil-image-frame mil-horizontal mil-drag'>
                                                <img src ='../img/grid/img_gallery/$grid_co_img_seven' alt='image'>
                                                <a data-fancybox='gallery' data-no-swup href='../img/grid/img_gallery/$grid_co_img_seven'  class='mil-zoom-btn'>
                                                    <img src ='../img/icons/zoom.svg' alt='zoom'>
                                                </a>
                                            </div>
                        ...
                        <div class="mil-works-nav mil-up">
                            ...
                            if ($grid_co_query) {
                                ...
                                while ($grid_co_data = mysqli_fetch_assoc($grid_co_query)) {
                                    ...
                                    $grid_co_role_two = $grid_co_data['role_two'];
                                    $grid_co_id = base64_encode($grid_co_data['id']);
                                    $grid_co_id = base64_encode(5);

                                    $num++;
                                }
                                echo "
                                    <a href='../project_5/?project= " . $grid_co_id . "' class='mil-link mil-dark mil-arrow-place mil-icon-left'>
