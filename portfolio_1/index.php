    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                <?php
                    include "../connection/connection.php";
                    $grid_heads_sql = "SELECT * FROM `grid_heads` WHERE 1";
                    $grid_heads_query = mysqli_query($connect, $grid_heads_sql);
                    $num = 1;
                    while ($grid_heads_data = mysqli_fetch_assoc($grid_heads_query)) {
                        $grid_heads_user_id = $grid_heads_data['user_id'];
                        $grid_heads_head_one = $grid_heads_data['grid_heads_head_one'];
                        $grid_heads_head_two = $grid_heads_data['grid_heads_head_two'];
                        $grid_heads_head_three = $grid_heads_data['grid_heads_head_three'];
                        $grid_heads_btn = $grid_heads_data['grid_heads_btn'];
                        $grid_heads_id = $grid_heads_data['id'];
                ...
                <div class="mil-inner-banner">
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            ...
                            <?php
                                echo "
                                    <h1 class='mil-mb-60'>$grid_heads_head_one <br> $grid_heads_head_two <span class='mil-thin'>$grid_heads_head_three</span></h1>
                                    <a href='#portfolio' class='mil-link mil-dark mil-arrow-place mil-down-arrow'>
                                        <span>$grid_heads_btn</span>
                                    </a>
                                ";
...
// Query to fetch data from `grid_co` table
$grid_co_sql = 'SELECT * FROM `grid_co` WHERE 1';
$grid_co_query = mysqli_query($connect, $grid_co_sql);
...
if ($grid_co_query) {
    ...
    // Initialize counter for determining column classes
    $num = 1;
    ...
    while ($grid_co_data = mysqli_fetch_assoc($grid_co_query)) {
        ...
        $grid_co_role_one = $grid_co_data['role_one'];
        $grid_co_role_two = $grid_co_data['role_two'];
        $grid_co_id_code = base64_encode($grid_co_data['id']);

        // Determine column class based on $num value
        if ($num == 1 || $num == 4 || $num == 5) {
            
           echo "<div class='col-lg-5'>

                    <a href='../project_" . $num . "/?project=" . $grid_co_id_code ."' class='mil-portfolio-item mil-more mil-mb-60'>

                        <div class='mil-cover-frame mil-vert mil-up'>
                            <div class='mil-cover'>
                                <img src='../img/grid/$grid_co_img' alt='cover'>
                            </div>
                        </div>
                        <div class='mil-descr'>
                            <div class='mil-labels mil-up mil-mb-15'>
                                <div class='mil-label mil-upper mil-accent'>$grid_co_head</div>
                                <div class='mil-label mil-upper'>$grid_co_date</div>
                            </div>
                            <h4 class='mil-up'>$grid_co_role_one $grid_co_role_two</h4>
                        </div>
                    </a>
          ...
          echo "
                <div class='col-lg-6'>
                    ...
                    <a href='../project_" . $num . "/?project=" . $grid_co_id_code ."' class='mil-portfolio-item mil-more mil-parallax mil-mb-60' data-value-1='60' data-value-2='-60'>
